...
if ( $action eq 'list' ) {
    ...
    $template->param(
        panel   => defined $input->param('module') ? scalar $input->param('module') : undef,
        page    => defined $input->param('page')   ? scalar $input->param('page')   : undef,
        table   => defined $input->param('table')  ? scalar $input->param('table')  : undef,
        modules => $modules,
    );
}
