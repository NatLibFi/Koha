...
subtest '_clean_search_term() tests' => sub {
    ...
    $res = $qb->_clean_search_term('host-item\:test:n:test:and:more more');
    is($res, 'host-item\:test:n\:test\:and\:more more', 'screen multiple colons properly also should skip backslashed one');
