...
INSERT INTO `marc_subfield_structure` (`tagfield`, `tagsubfield`, `liblibrarian`, `libopac`, `repeatable`, `mandatory`, `kohafield`, `tab`, `authorised_value`, `authtypecode`, `value_builder`, `isurl`, `hidden`, `frameworkcode`, `seealso`, `link`, `defaultvalue`) VALUES
		...
		('440', '9', '9 (RLIN)', '9 (RLIN)', 0, 0, '', 4, '', '', '', 0, -6, '', '', '', NULL),
		('440', 'a', 'Title', 'Title', 0, 0, 'biblio.seriestitle', 4, '', 'UNIF_TITLE', '', NULL, -6, '', '''440n'',''440p'',''490a'',''830a'',''830n'',''830p'',''899a''', '', NULL),
		('440', 'n', 'Number of part/section of a work', 'Number of part/section of a work', 1, 0, 'biblioitems.number', 4, '', '', '', NULL, -6, '', '', '', NULL),
		('440', 'p', 'Name of part/section of a work', 'Name of part/section of a work', 1, 0, '', 4, '', '', '', NULL, -6, '', '', '', NULL),
		('440', 'v', 'Volume number/sequential designation', 'Volume number/sequential designation', 0, 0, 'biblioitems.volume', 4, '', '', '', NULL, -6, '', '', '', NULL),
		('440', 'x', 'International Standard Serial Number', 'International Standard Serial Number', 0, 0, '', 4, '', '', '', NULL, -6, '', '', '', NULL),
		('490', '3', 'Materials specified', 'Materials specified', 0, 0, '', 4, '', '', '', NULL, 0, '', '', '', NULL),
		...
		('490', 'a', 'Series statement', 'Series statement', 1, 0, 'biblioitems.seriestitle', 4, '', '', '', NULL, 0, '', '', '', NULL),
		('490', 'l', 'Library of Congress call number', 'Library of Congress call number', 0, 0, '', 4, '', '', '', NULL, -6, '', '', '', NULL),
		('490', 'v', 'Volume number/sequential designation', 'Volume number/sequential designation', 1, 0, 'biblioitems.volume', 4, '', '', '', NULL, 0, '', '', '', NULL),
		('490', 'x', 'International Standard Serial Number', 'International Standard Serial Number', 0, 0, '', 4, '', '', '', NULL, 0, '', '', '', NULL),
